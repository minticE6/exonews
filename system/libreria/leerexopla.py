...
try:
    ...
    tabla_exoplanetas = marca1.drop(['Excentricidad', 'Semieje mayor', 'Tipo estelar', 'Temperatura', 'Distancia', 'Método', 'Masa', 'Radio', 'Periodo orbital'], axis=1) #cp: eliminan columnas no necesarias.
